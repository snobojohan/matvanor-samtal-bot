...
export const surveyQuestions: SurveyData = {
  // Welcome Section
  welcome: {
    message: "Hej och välkommen till vår undersökning om matvanor! Vi är intresserade av att förstå hur du och din eventuella familj hanterar mat i vardagen. Dina svar hjälper oss att förstå verkliga utmaningar och behov. Undersökningen tar cirka 10-15 minuter. Vill du börja?",
    type: "single_choice",
  ...
  early_exit: {
    message: "Tack ändå! Om du har några frågor är du välkommen att <a href='https://matkompis.se/'>kontakta oss</a>!",
    end: true
  },
  ...
  unsure_food_decision: {
    message: "När du senast undrade 'vad ska vi äta idag?' – vad gjorde ni då?",
    type: "text",
